            ...
            <div className="container">
              ...
              <div className="section-head text-center wide-auto-sm">
                ...
                <p className="animated" data-animate="fadeInUp" data-delay=".2">
                  ...
                  Since man can’t survive without food, Some individuals decided
                  to take a profession called farming to produce food to reduce
                  food shortage and rescue the situation. Gonana offers a wide
                  range of solutions to tackle this problem and correct the
                  notion of people about farming; also how farming can be a very
                  good paying job for anyone around the world with the right
                  solution like Gonana.
                </p>
              </div>
              {/* .section-head @e */}
              {/* Block @s */}
                      ...
                      <div className="feature boxed bg-white-10">
                        <div className="feature-text">
                          ...
                          <p>
                            ...
                            of charges. This is to help the farmers take as much
                            profit as possible as a reward for the hard work
                            they put on production. There will be no hidden
                            charges due to Gonana as a company or any other
                            party.{" "}
                          </p>
                        </div>
                      </div>
                      <div className="feature boxed bg-white-2">
                        <div className="feature-text">
                          ...
                          <p>
                            ...
                            that every farmer gives products as displayed on the
                            Marketplace to help cut down any form of dishonesty
                            or fraud in the system. Also these logistics
                            companies take full responsibility for any damage or
                            loss of produce that are handled by them. The
                            customer can be guaranteed quality, safety and also
                            on time delivery.
                          </p>
                        </div>
                      </div>
                      <div className="feature boxed bg-black-10">
                        <div className="feature-text">
                          ...
                          <p>
                            ...
                            some profit for their Defi activities. This is to
                            help the farmers have a holistic approach to Defi
                            and Cefi. Also, farmers get a multi-chain exchange
                            where they can use assets from other blockchain
                            protocols like Algorand, XDC, Evmos, Acala, Celo,
                            Solana and Near.
                          </p>
                        </div>
                      </div>
                        ...
                        <div className="col-md-6">
                          <div className="nk-block-text">
                            ...
                            <p>
                              ...
                              and it will be the default token for rewards on
                              the Gonana DApp. Users making payment or
                              performing any form of transaction on the DApp
                              with the Gona token will have some form of
                              cashback in form of a discount. The token will be
                              used to reward liquidity providers on the Gonana
                              DEX and those who earn any reward by using the
                              DApp. Token will also be used to fund development
                              activities of the Gonana ecosystem.{" "}
                            </p>
                  ...
                  <div className="col-lg-7">
                    <div className="team-featured-cont">
                      ...
                      >
                        ...
                        knowledge of JavaScript and React. He works with
                        reputable blockchain projects like Algorand and EVM. His
                        love for educating people about blockchain technology
                        and its applications led him to set up various
                        blockchain communities across Nigeria.
                      </p>
                      <p
                        className="animated"
                        data-animate="fadeInUp"
                      ...
                      >
                        ...
                        in Africa at the University of Jos) and also Jaysources,
                        a DApp deployed on the Algorand.
                      </p>
                    </div>
                  </div>
                </div>
